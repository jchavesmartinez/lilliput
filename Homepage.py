    ...
    if search_barcode_form:
        ...
        if filtered_data:
            ...
            with st.form("my_form", clear_on_submit=False):
                ...
                methods = [values_from_dict1['Purification_methods'], "Filter 0.2 um", "Filter 0.2 um + Ultracentrifugation", "Filter 0.2 um + Ultracentrifugation+ dialysis"]
                ...
                with col1:
                    ...
                    input_values["Purification_methods"] = st.selectbox("Purification Methods", unique_methods )
